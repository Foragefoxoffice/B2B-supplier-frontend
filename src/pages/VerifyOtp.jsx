...
import { verifyOtpApi } from '../commonApi/api';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Pass email and otp to the reset password page
        ...
        >
          <div className="bg-white rounded-[1rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100/90 p-8 sm:p-7 mt-2">
            <div className="mb-5 text-center">
              <h2 className="text-3xl font-semibold text-slate-900 mb-2 tracking-tight">Enter OTP</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    maxLength={6}
                    className="block w-full pl-11 pr-4 py-3 border border-slate-200 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-600 transition-all outline-none text-slate-800 text-sm bg-slate-50 hover:bg-slate-100/50 tracking-widest text-center text-lg"
                    placeholder="------"
                    value={otp}
              ...
              <div className="text-center mt-4">
                <Link to="/forgot-password" className="text-sm font-semibold text-slate-500 hover:text-slate-800 transition-colors">
